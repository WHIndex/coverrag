#!/usr/bin/env python3
"""Batch runner for COVER-RAG v3.

This script is resume-friendly:
  - existing v3 JSON files are skipped unless --force-revise is set;
...
SUMMARY_COLUMNS: list[tuple[str, str, str]] = [
    ...
    ("v3_examples", "cover_v3_summary_num_examples", "int"),
    ("v3_draft_claims", "cover_v3_summary_draft_num_claims", "int"),
    ("v3_initial_supported", "cover_v3_summary_initially_supported_claims", "int"),
    ("v3_recovered_claims", "cover_v3_summary_recovered_claims", "int"),
    ("v3_expanded_claims", "cover_v3_summary_expanded_claims", "int"),
    ("v3_draft_aligned_kept", "cover_v3_summary_draft_aligned_kept_claims", "int"),
    ("v3_verified_plus_expanded", "cover_v3_summary_verified_plus_expanded_claims", "int"),
    ("v3_kept_claims", "cover_v3_summary_kept_verified_claims", "int"),
    ("v3_rejected_claims", "cover_v3_summary_rejected_claims", "int"),
    ("v3_recovery_attempted", "cover_v3_summary_recovery_attempted_claims", "int"),
    ("v3_recovery_successful", "cover_v3_summary_recovery_successful_claims", "int"),
    ("v3_recovery_success_rate", "cover_v3_summary_recovery_success_rate_micro", "rate"),
    ("v3_expansion_candidates", "cover_v3_summary_expansion_candidate_claims", "int"),
    ("v3_expansion_attempted", "cover_v3_summary_expansion_attempted_claims", "int"),
    ("v3_expansion_successful", "cover_v3_summary_expansion_successful_claims", "int"),
    ("v3_expansion_success_rate", "cover_v3_summary_expansion_success_rate_micro", "rate"),
    ("v3_expanded_answer_spans", "cover_v3_summary_expanded_answer_spans", "int"),
    ("v3_recall_target_mismatch", "cover_v3_summary_recall_completion_target_mismatches", "int"),
    ("v3_recall_no_targets", "cover_v3_summary_recall_completion_no_targets", "int"),
    ("v3_expansion_low_answer_unit_score", "cover_v3_summary_expansion_low_answer_unit_score", "int"),
    ("v3_expansion_low_target_relevance", "cover_v3_summary_expansion_low_target_relevance", "int"),
    ("v3_expansion_low_explanatory_precision", "cover_v3_summary_expansion_low_explanatory_precision", "int"),
    ("v3_expansion_surface_filtered", "cover_v3_summary_expansion_surface_filtered", "int"),
    ("v3_expansion_answer_unit_filtered", "cover_v3_summary_expansion_answer_unit_filtered", "int"),
    ("v3_iterative_completion_claims", "cover_v3_summary_iterative_completion_claims", "int"),
    ("v3_iterative_completion_attempts", "cover_v3_summary_iterative_completion_attempts", "int"),
    ("v3_iterative_completion_successful", "cover_v3_summary_iterative_completion_successful_claims", "int"),
    ("v3_iterative_completion_success_rate", "cover_v3_summary_iterative_completion_success_rate_micro", "rate"),
    ("v3_dynamic_retrieval_rounds", "cover_v3_summary_dynamic_retrieval_rounds", "int"),
    ("v3_dynamic_retrieval_queries", "cover_v3_summary_dynamic_retrieval_queries", "int"),
    ("v3_dynamic_retrieval_added_docs", "cover_v3_summary_dynamic_retrieval_added_docs", "int"),
    ("v3_dynamic_retrieval_successful_rounds", "cover_v3_summary_dynamic_retrieval_successful_rounds", "int"),
    ("v3_dynamic_retrieval_added_docs_per_example", "cover_v3_summary_dynamic_retrieval_added_docs_per_example", "float"),
    ("v3_coverage_guided_retrieval_rounds", "cover_v3_summary_coverage_guided_retrieval_rounds", "int"),
    ("v3_coverage_guided_retrieval_targets", "cover_v3_summary_coverage_guided_retrieval_targets", "int"),
    (
        "v3_coverage_guided_retrieval_skipped_no_targets",
        "cover_v3_summary_coverage_guided_retrieval_skipped_no_targets",
        "int",
    ),
    ("v3_explanation_render_examples", "cover_v3_summary_explanation_render_examples", "int"),
    ("v3_explanation_render_selected", "cover_v3_summary_explanation_render_selected_claims", "int"),
    ("v3_explanation_render_length_limited", "cover_v3_summary_explanation_render_length_limited_claims", "int"),
    ("v3_candidate_selection_examples", "cover_v3_summary_candidate_selection_examples", "int"),
    ("v3_candidate_selection_changed", "cover_v3_summary_candidate_selection_changed_outputs", "int"),
    ("v3_candidate_selection_candidates", "cover_v3_summary_candidate_selection_total_candidates", "int"),
    ("v3_candidate_selection_audit_failures", "cover_v3_summary_candidate_selection_audit_failures", "int"),
    ("v3_candidate_selected_current", "cover_v3_summary_candidate_selection_selected_labels_current", "int"),
    ("v3_candidate_selected_base", "cover_v3_summary_candidate_selection_selected_labels_base_preserving", "int"),
    ("v3_candidate_selected_integrated", "cover_v3_summary_candidate_selection_selected_labels_integrated", "int"),
    ("v3_candidate_selected_recall", "cover_v3_summary_candidate_selection_selected_labels_recall_heavy", "int"),
    ("v3_keep_rate", "cover_v3_summary_claim_keep_rate_micro", "rate"),
    ("v3_rejected_rate", "cover_v3_summary_rejected_claim_rate_micro", "rate"),
    ("v3_avg_revised_length", "cover_v3_summary_avg_revised_length", "float"),
    ("v3_avg_revised_citations", "cover_v3_summary_avg_revised_num_citations", "float"),
    ("v3_avg_doc_pool_size", "cover_v3_summary_avg_doc_pool_size", "float"),
    ("v3_draft_supported", "cover_v3_summary_draft_label_counts_supported", "int"),
    ("v3_draft_wrong_missing", "cover_v3_summary_draft_label_counts_wrong_or_missing_citation", "int"),
    ("v3_draft_not_supported", "cover_v3_summary_draft_label_counts_not_supported", "int"),
    ("v3_draft_no_citation", "cover_v3_summary_draft_label_counts_no_citation", "int"),
    ("final_claims", "cover_v3_final_audit_summary_num_claims", "int"),
    ("final_claim_support_rate", "cover_v3_final_audit_summary_atomic_claim_support_rate_micro", "rate"),
    ("final_claim_unsupported_rate", "cover_v3_final_audit_summary_unsupported_claim_rate_micro", "rate"),
    ("final_no_citation_claims", "cover_v3_final_audit_summary_no_citation_claims", "int"),
]
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Batch run COVER-RAG v3.")
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("result/cover_v3"))
    parser.add_argument("--python", default=sys.executable)
    parser.add_argument("--limit", type=int, default=None, help="Only process the first N examples in each input.")
    parser.add_argument("--checkpoint-every", type=int, default=0, help="Pass through to cover_v3_iterative.py.")
    ...
    parser.add_argument("--cache-file", type=Path, default=Path("cache/cover_v3_cache.json"))
    parser.add_argument(
        "--cache-save-every",
        type=int,
        default=1,
        help="Pass through to cover_v3_iterative.py to reduce JSON cache write frequency.",
    )
    parser.add_argument(
        "--revision-workers",
        type=int,
        default=1,
        help="Pass through to cover_v3_iterative.py --workers for concurrent per-example revision.",
    )
    ...
    parser.add_argument("--summary-csv", type=Path, default=Path("result/cover_v3/cover_v3_comparison.csv"))
    parser.add_argument("--summary-md", type=Path, default=Path("result/cover_v3/cover_v3_comparison.md"))
    return parser.parse_args()


def cover_v3_path(raw: Path, output_dir: Path) -> Path:
    return output_dir / f"{raw.stem}.cover_v3.json"


def build_revise_cmd(args: argparse.Namespace, root: Path, raw: Path, out: Path) -> list[str | Path]:
    cmd: list[str | Path] = [
        args.python,
        root / "scripts" / "cover_v3_iterative.py",
        "--input",
        raw,
        "--output",
        out,
...
def main() -> int:
    ...
    for index, raw in enumerate(inputs, start=1):
        cover = cover_v3_path(raw, output_dir)
        ...
        try:
            if args.force_revise or not cover.exists():
                ...
                print(f"  cover_v3 exists, skip: {display(root, cover)}")
